...
RexReplace is a versetile tool for command line search-and-replaces in files. Features you might like: 


- Defaults to global multiline case-insensitive search.
- Supports regex lookaheads in pattern and backreference to matching groups in the replacement. 
...
- Replacement can be dynamicly generated by javascript code.
