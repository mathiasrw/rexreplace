...
- Text to be seached can be piped in or multiple files can be given as [glob notation](https://www.tcl.tk/man/tcl8.5/tutorial/Tcl16a.html) (so `docs/*.md` represents each markdown file in your `docs/` dir).
