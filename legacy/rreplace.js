...
if (process.argv.length < 5) throw 'Too few arguments given.' + usage;

if (7 < process.argv.length) throw 'Too many arguments given.' + usage;
...
if (6 <= process.argv.length) flags = process.argv[5];

var encoding = 'utf8';

if (7 === process.argv.length) encoding = process.argv[6];
